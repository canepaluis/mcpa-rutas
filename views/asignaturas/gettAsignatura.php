												...
												<div class= "row">
													...
													<div class="col-sm-12 col-md-8 col-lg-5">
														<div class="formulario__grupo" id="grupo__nombreasignatura">
															...
															<div class="formulario__grupo-input">
																<input type="text" class="formulario__input form-control" name="nombreasignatura" id="nombreasignatura" placeholder="Nombre de la asignatura" value="<?php if (isset($this->resultado["Nombre_Asig"])) echo $this->resultado["Nombre_Asig"]; ?>"required disabled>
															</div>
													...
													<div class="row">
														...
														<div class="col-sm-12 col-md-3 col-lg-3">
															<div class="formulario__grupo" id="grupo__unidades">
																...
																<div class="formulario__grupo-input">
																	<input type="text" class="formulario__input form-control" name="unidades" id="unidades" placeholder="0" value="<?php if (isset($this->numero_unidades["COUNT(*)"])) echo $this->numero_unidades["COUNT(*)"]; ?>" disabled>
																</div>
																<p class="formulario__input-error">Solo puede contener caracteres tipo letra y maximo de 40.</p>
															</div>
														...
														<div class="col-sm-12 col-md-9 col-lg-9">
															<div class="formulario__grupo d-grid" id="grupo__nombrecortoasignatura">
																...
																<button type="button" class="btn btn-primary" onclick="cantidadunidades(), quitarmensajeunidades(), agregarunidad()" id="nuevaunidad" data-bs-toggle="modal" data-bs-target="#exampleModal"> <i class="zmdi zmdi-plus-circle"></i> Agregar unidad</button>
															</div>
													...
													<div class="table-responsive">
														...
														if(isset($this->unidad)){
															...
															<tr class="colortr" >
																...
																<td style="text-align: center"><a class="btn btn-primary btn-sm" id='<?php echo "button".$i ?>' href="<?php echo URL;?>asignaturas/gettoupdateUnidad?k=<?php echo $i;?>" type="button"><i class="zmdi zmdi-edit"></i></a></td>
																<td style="text-align: center"><a class="btn btn-danger btn-sm" id='<?php echo "button".$i ?>' onclick="eliminarUnidad();" type="button"><i class="zmdi zmdi-edit"></i></a></td>
																<script>
																	...
																	type: 'warning',
																		...
																		window.location.href='<?php echo URL;?>asignaturas/eliminarUnidad?id_objetivo=<?php echo $i;?>';
							...
							<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
								  <div class="modal-content">
									...
									<form id="validacion_modalunidades" method="POST" action="<?php echo constant('URL'); ?>asignaturas/setUnidad">
										<div class="container">
											<div class="row">
												<!--Input unidad-->
													<div class="col-sm-12 col-md-4">
														<div class="formulario__grupo" id="grupo__numerounidad">
															...
															<div class="formulario__grupo-input">
																<textarea type="text" class="formulario__input form-control" rows="2" name="numerounidad" id="numerounidad" placeholder="Unidad" required></textarea>
															</div>
															<p class="formulario__input-error">Solo puede contener caracteres tipo letra y maximo de 40.</p>
														</div>
													</div>
		...
		switch($session->get("tipoAlerta")){
			...
			case 'Agregar':
				echo "<script>
					...
					text: 'La asignatura ha sido agregada exitosamente, recuerde agregar las unidades.',
					type: 'success',
						confirmButtonColor: '#03A9F4',
						cancelButtonColor: '#F44336',
						confirmButtonText: 'Cerrar',
