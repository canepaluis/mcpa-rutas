							...
							<div id="exampleModal" aria-labelledby="exampleModalLabel">
								<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
								  <div class="modal-content">
									...
									<form id="validacion_modalunidades" method="POST"action="<?php echo constant('URL'); ?>asignaturas/updateUnidad">
										<div class="container">
											<div class="row">
												<!--Input unidad-->
										...
										<div class="modal-footer">
                                            <a class="btn btn-secondary" href="<?php echo URL;?>asignaturas/getUnidad" type="button">Regresar</a>
											<button type="submit" form="validacion_modalunidades" class="btn btn-primary" id="actualizar_unidad" action="<?php echo constant('URL'); ?>asignaturas/updateUnidad">Actualizar información</button>
										</div>
									</form>
								  </div>
								</div>
