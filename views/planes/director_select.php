									...
									<section class="full-box">
										<div class="contenido">
											...
											<div class="contenido-box">
												...
												<div class="" >
													<form class="" action="<?php echo constant('URL'); ?>planes/getBuscador" method="POST">
												...
												<div class="formulario-box">
													<form class="diseño-formulario" id="validacionplanes" action="<?php echo constant('URL'); ?>planes/actualizarPlan" method="POST" >
																...
																<div class= "row">
																	<div class="col-sm-12 col-md-12 ">
																		<div class="formulario__grupo" id="grupo__carrera">
																			...
																			<div class="formulario__grupo-input">
																				<input type="text" class="formulario__input form-control" name="carrera" id="carrera" placeholder="Nombre oficial de la carrera"  readonly=»readonly» value="<?php echo $this->resultadoPlan['Nom_Carrera'];?>" >
																			</div>
																	...
																	<div class="col-sm-12 col-md-12 ">
																		<div class="formulario__grupo" id="grupo__carrera">
																			...
																			<div class="formulario__grupo-input">
																				<input type="text" class="formulario__input form-control" name="totalmaterias" id="totalmaterias" placeholder="Total Materias" required disabled value="<?php echo $this->resultadoPlan['Total_Materias'];?>">
																			</div>
																			<p class="formulario__input-error">Solo puede contener caracteres tipo letra y maximo de 40.</p>
																		</div>
																...
																<div class="row ">
																	<div class="col-sm-12 col-md-6">
																		<div class="formulario__grupo" id="grupo__plan">
																			...
																			<div class="formulario__grupo-input">
																				<input type="text" class="formulario__input form-control" name="plan" id="plan" placeholder="Plan académico" readonly=»readonly»  value="<?php echo $this->resultadoPlan['Cod_Revision'];?>">
																	...
																	<div class="col-sm-12 col-md-6">
																		<div class="formulario__grupo" id="grupo__claveoficial">
																			...
																			<div class="formulario__grupo-input">
																				<input type="text" class="formulario__input form-control" name="claveoficial" id="claveoficial" placeholder="Clave oficial del plan académico" required disabled value="<?php echo $this->resultadoPlan['Clave_Oficial'];?>">
																...
																<div class="row ">
																	...
																	<div class="col-sm-12 col-md-6 col-lg-4">
																		<div class="formulario__grupo" id="grupo__periododuracion">
																			...
																			<div class="formulario__grupo-input">
																				<input type="text" class="formulario__input form-control" name="periododuracion" id="periododuracion" placeholder="Periodo de duración" required disabled value="<?php echo $this->resultadoPlan['Per_Duracion'];?>">
																	...
																	<div class="col-sm-12 col-md-6 col-lg-4">
																		<div class="formulario__grupo" id="grupo__creditostotales">
																			...
																			<div class="formulario__grupo-input">
																				<input type="text" class="formulario__input form-control" name="creditostotales" id="creditostotales" placeholder="Créditos totales" required disabled value="<?php echo $this->resultadoPlan['Creditos_Total'];?>">
																	...
																	<div class="col-sm-12 col-md-12 col-lg-4">
																		<div class="formulario__grupo" id="grupo__periodomaximo">
																			...
																			<div class="formulario__grupo-input">
																				<input type="text" class="formulario__input form-control" name="periodomaximo" id="periodomaximo" placeholder="Periodo máximo" required disabled value="<?php echo $this->resultadoPlan['Per_Max'];?>">
																	...
																	<table id="example" class="table table-striped color-tabla" style="width:100%">
																			...
																			<tbody>
																				<tr>
																					...
																					<td style="text-align: center"><a href="<?php echo URL;?>planes/gettoAsignatura?k=<?php echo $i;?>" class="btn btn-danger btn-sm editar-boton"><i class="zmdi zmdi-edit"></i></a></td>
																				</tr>
																				<?php $i++;} ?>																				
																			</tbody>
